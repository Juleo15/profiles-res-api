...
PROJECT_GIT_URL='https://github.com/Juleo15/profiles-res-api.git'
...
# Run migrations
$PROJECT_BASE_PATH/env/bin/python $PROJECT_BASE_PATH/src/profiles_project/manage.py migrate
